...
553 real tasks across 37 roles, each classified: stays with the person, augmented, automated, or newly created by AI. Two data layers: O*NET (US Department of Labor, db 30.0) as the floor, plus 20 advertised roles at VC and PE-backed companies (UK and US) for the modern People jobs O*NET does not know exist. Every call carries its reason, and the close calls are flagged.
